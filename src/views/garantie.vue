<template>
	<div class="container infoPage ">
		...
		<div class="content">
			...
			<h4 class="header mrt-10 mrb-3">Если вы уже купили товар и нашли дешевле</h4>
			<p class="text_base1 black_90 mrt-0 mrb-0">
				Если в течение 14 дней после совершения покупки Вы нашли в розничном или интернет-магазине из списка
				конкурентов аналогичный товар по более низкой цене, мы компенсируем вам разницу.
			</p>
			<div class="warning blue mrt-10 mrb-20">
				<p class="text_base1_bold black_90 mrt-0 mrb-0">Список конкурентов</p>
