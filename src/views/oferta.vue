<template>
	<div class="container infoPage ">
		...
		<div class="content">
			...
			<ul class="numbered-list double list_one text_base1">
				<li>
			...
			<ul class="numbered-list double list_two text_base1">
				<li>
			...
			<ul class="numbered-list double list_three text_base1">
				<li>
				...
				<li>
					...
					<ul class="numbered-list triple list_three_sub text_base1">
			...
			<ul class="numbered-list double list_four text_base1">
				<li>
			...
			<ul class="numbered-list double list_five text_base1">
				<li>
			...
			<p class="text_base1 mrt-5 mrb-0">
